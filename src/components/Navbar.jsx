        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            {localStorage.getItem('token') ? (
              <button className={`auth-btn text-${loginMode}`} onClick={handleLogout}>Logout</button>
            ) : (
              <Link className={`auth-btn text-${loginMode}`} to="/signup">Sign Up</Link>
            )}

            <Link className={`profile-btn text-${loginMode}`} to="/profile"><i className="fa-solid fa-user"></i></Link>
          </div>
        </div>
      </nav>
    </div>
